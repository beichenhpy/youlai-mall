...
public class MemberController {
    ...
    @ApiImplicitParam(name = "member", value = "实体JSON对象", required = true, paramType = "body", dataType = "UmsMember")
    @PutMapping("/{id}")
    public Result<Void> add(@PathVariable Long id, @RequestBody UmsMember user) {
    ...
    public Result<Void> updatePoint(@PathVariable Long id, @RequestParam Integer num) {
    ...
    public Result<Void> updateBalance(@PathVariable Long id, @RequestParam Long balance) {
